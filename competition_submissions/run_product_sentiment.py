...
from auto_mm_bench.datasets import dataset_registry, _TEXT, _NUMERICAL, _CATEGORICAL, MachineHackSentimentPrediction
...
parser.add_argument('--save_dir', default='machine_hack_product_sentiment', type=str)
...
feature_generator = AutoMLPipelineFeatureGenerator(
    vectorizer=CountVectorizer(min_df=30, ngram_range=(1, 3),
...
train_dataset = MachineHackSentimentPrediction('train')
test_dataset = MachineHackSentimentPrediction('test')
competition_dataset = MachineHackSentimentPrediction('competition')
